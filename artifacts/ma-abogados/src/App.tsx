...
const practices: Practice[] = [
  { number: '01', title: 'Derecho civil', copy: 'Abogados civiles en Zamora para contratos, bienes, acuerdos y protección patrimonial.', icon: Landmark },
  { number: '02', title: 'Infonavit', copy: 'Asesoría Infonavit en Zamora para regularización, crédito y defensa del patrimonio habitacional.', icon: Gavel },
  { number: '03', title: 'Derecho familiar', copy: 'Abogados familiares en Zamora con acompañamiento humano en asuntos sensibles y decisiones familiares.', icon: Scale },
  { number: '04', title: 'Prevención jurídica', copy: 'Prevención jurídica y cumplimiento para anticipar riesgos, ordenar documentos y evitar litigios.', icon: ShieldCheck },
];
          ...
          <div className="hero-content relative z-10 mx-auto w-full max-w-[1280px] px-6 lg:px-10">
            <div className="grid items-end gap-12 md:grid-cols-[1.1fr_.9fr]">
              <div>
                ...
                <h1 className="display max-w-[790px] text-[clamp(3.8rem,9.5vw,8.5rem)] leading-[.88] tracking-[-.055em] text-[#1e2435]">Despacho de<br />abogados en<br /><em className="text-[#9a702b]">Zamora.</em></h1>
              ...
              <div className="hidden justify-end pb-5 md:flex">
                <div className="max-w-[215px] border-l border-[#a9a698] pl-5">
                  <Monogram />
                  <p className="mt-5 text-[11px] leading-[1.6] text-[#666a74]">Un despacho jurídico en Zamora para decisiones que merecen hacerse bien.</p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-[1280px]">
            <div className="grid gap-14 md:grid-cols-[.75fr_1.25fr] md:gap-24">
              ...
              <div>
                ...
                <p className="max-w-[670px] text-[clamp(1.4rem,2.8vw,2.3rem)] leading-[1.3] tracking-[-.025em] text-[#303548]">No creemos en respuestas automáticas. Desde Zamora, Michoacán, miramos cada asunto de frente para convertir la incertidumbre legal en un camino posible.</p>
        ...
        <section id="practicas" className="bg-[#1e2435] px-6 py-24 text-[#f1eee6] md:py-32 lg:px-10">
          <div className="mx-auto max-w-[1280px]">
            <div className="flex flex-col justify-between gap-7 border-b border-[#444958] pb-9 md:flex-row md:items-end">
              <div><p className="eyebrow">Servicios legales en Zamora</p><h2 className="display mt-5 max-w-[610px] text-5xl leading-[.98] tracking-[-.04em] md:text-7xl">La precisión no<br /><em>es opcional.</em></h2></div>
              <p className="max-w-[280px] text-[13px] leading-[1.65] text-[#a9acb2]">Derecho civil, derecho familiar, asesoría Infonavit y prevención jurídica para proteger sus intereses hoy.</p>
            </div>
      ...
      <footer className="bg-[#171c2b] px-6 pb-8 pt-14 text-[#e6e0d2] lg:px-10">
        <div className="mx-auto max-w-[1280px]">
          <div className="grid gap-8 border-b border-[#3c4250] py-10 md:grid-cols-[.65fr_1.35fr] md:items-center">
            <div>
              <p className="eyebrow !text-[#e4bf6a]">¿Dónde nos encontramos?</p>
          ...
          <div className="flex flex-col justify-between gap-12 border-b border-[#3c4250] py-14 md:flex-row md:items-end">
            <div><Monogram light /><p className="mt-7 max-w-[280px] text-[12px] leading-[1.65] text-[#9ea2ab]">Claridad legal en Zamora para decisiones que importan.</p></div>
