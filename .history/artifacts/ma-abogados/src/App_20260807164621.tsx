...
const practices: Practice[] = [
  { number: '01', title: 'Derecho civil', copy: 'Estrategia, certeza y blindaje legal para potenciar cada decisión de negocio.', icon: Landmark },
  { number: '02', title: 'Infonavit', copy: 'Representación contundente y solución efectiva en litigios de alta exigencia.', icon: Gavel },
  { number: '03', title: 'Derecho familiar', copy: 'Protección humana y soluciones patrimoniales con la máxima discreción.', icon: Scale },
  { number: '04', title: 'Prevención y cumplimiento', copy: 'Mitigación proactiva de riesgos para garantizar la continuidad de su operación.', icon: ShieldCheck },
];
