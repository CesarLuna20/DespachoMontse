...
const practices: Practice[] = [
  { number: '01', title: 'Derecho corporativo', copy: 'Decisiones empresariales con estructura, visión y respaldo legal.', icon: Landmark },
  { number: '02', title: 'Litigio estratégico', copy: 'Defensa firme cuando el diálogo ya no es suficiente.', icon: Gavel },
  { number: '03', title: 'Derecho civil y familiar', copy: 'Acompañamiento cercano en los asuntos que importan de verdad.', icon: Scale },
  { number: '04', title: 'Prevención y cumplimiento', copy: 'Anticipamos riesgos para que su operación avance con confianza.', icon: ShieldCheck },
];
...
function IntroScreen({ onSkip }: { onSkip: () => void }) {
  return (
    <div className="intro-screen fixed inset-0 z-[100] flex min-h-[100dvh] items-center justify-center bg-[#171c2b] text-[#e6e0d2]" aria-label="Presentación de M&A Abogados">
        ...
        <section id="inicio" className="relative flex min-h-[760px] items-end overflow-hidden bg-[#e8e5dc] pb-16 pt-32 md:min-h-[850px] md:pb-24">
          ...
          <div className="hero-content relative z-10 mx-auto w-full max-w-[1280px] px-6 lg:px-10">
            <div className="grid items-end gap-12 md:grid-cols-[1.1fr_.9fr]">
              <div>
                <p className="eyebrow mb-7">M&A abogados · desde 2008</p>
            ...
            <div className="grid gap-14 md:grid-cols-[.75fr_1.25fr] md:gap-24">
              ...
              <div>
                ...
                <div className="mt-12 grid gap-8 border-t border-[#d1ccc0] pt-7 sm:grid-cols-3">
                  <div><p className="display text-4xl text-[#9a702b]">16</p><p className="mono mt-2 text-[9px] text-[#6f7078]">años de experiencia</p></div>
                  <div><p className="display text-4xl text-[#9a702b]">03</p><p className="mono mt-2 text-[9px] text-[#6f7078]">ciudades de atención</p></div>
